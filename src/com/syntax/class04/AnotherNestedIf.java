...
public class AnotherNestedIf {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 
		 * if u done test then I want to check the score
		 * 
		 * score is more than 90----> A student score is more than 80----> B student
		 * score is more than 70----> C student otherwise: you should study more for
		 * test
		 * 
		 * 
		 */
